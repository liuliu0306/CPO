...
class TestMutableULList(unittest.TestCase):
    ...
    def test_capacity(self):
        ...
        ull1 = UnrolledLinkedList(6)
        self.assertEqual(ull1.capacity, 6)

        ull2 = UnrolledLinkedList(3)
        self.assertEqual(ull2.capacity, 3)
...
# ---------------------------------------------
    ...
    def test_monoid_properties_PBT(self, a):
        print('Testing monoid properties PBT...')
    ...
    def test_monoid_associativity_PBT(self, a):
        print('Testing monoid associativity PBT...')
        ull1 = UnrolledLinkedList()
        ull2 = UnrolledLinkedList()
        ull1.from_list(a[:5])
        ull2.from_list(a[5:])
        ie1 = ull1.concat(ull2).to_list()
        self.assertEqual(ie1, a)
